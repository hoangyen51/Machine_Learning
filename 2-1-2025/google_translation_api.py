...
class TextTranslatorApp:
    ...
    def translate_text(self):
        ...
        text_to_translate=self.entry

        url=f"http://translation.googleleapis.com/language/translate/v2?key={api_key}"
        params={
            'q':text_to_translate,
        ...
        translated_text=response.json()['data']['translation'][0]['translation'][0]['translatedText']
